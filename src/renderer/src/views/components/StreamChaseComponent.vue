...
.c-stream-chase__items[count="1"] {
    .c-stream-chase__item--participant:nth-of-type(1) {
...
export default {
    ...
    computed: {
        count() {
            ...
            if ('ahead' in this.chase && this.chase.ahead !== null) {
                count++;
            }

            if ('behind' in this.chase && this.chase.behind !== null) {
                count++;
            }
