<template>
    <div class="c-pit-fuel-calc" v-if="true">
        ...
        <div class="c-pit-fuel-calc__rows">
...
import PitDataHeadingComponent from './PitDataHeadingComponent.vue';
import PitDataValueComponent from './PitDataValueComponent.vue';
